...
,
  ...
  amicus:{name:'Amicus Reconnect - Reentry Drop-In',tagline:'Free drop-in reentry services for people with a criminal background. Housing, jobs, transportation, clothing, computer and phone access. No appointment needed.',phone:'612-877-4250',addr:'3041 4th Ave S, Minneapolis 55408',hrs:'Monday through Friday, 9am-noon and 1-3pm',url:'https://www.voamnwi.org/amicus-reconnect-services',langs:['English'],urg:false,d:['mpls_north','mpls_ne','mpls_phillips','mpls_cedar','mpls_south','mpls_any']},

  voa_reentry:{name:'Volunteers of America - Residential Reentry',tagline:'Halfway house for people completing their sentence in the community. Employment, housing, substance use support, and case management. Minneapolis location.',phone:'612-278-4200',addr:'Lake Street RRC: 2825 E Lake St, Minneapolis 55406. Roseville RRC: 1771 Kent St, Roseville 55113',hrs:'Call for intake information',url:'https://www.voamnwi.org/residential-reentry-centers',langs:['English'],urg:false,d:['mpls_north','mpls_ne','mpls_phillips','mpls_cedar','mpls_south','mpls_any']},
  ...
  svc:{name:'Sexual Violence Center - Minneapolis/Hennepin',tagline:'Free, confidential support for survivors of sexual violence in Hennepin, Scott, and Carver counties. 24-hour crisis line, individual counseling, hospital advocacy, support groups, and legal advocacy. All genders welcome, ages 12 and up. You do not have to report to police.',phone:'612-871-5111',addr:'2600 E 25th St Suite C, Minneapolis 55406',hrs:'24-hour crisis line. Office: Mon-Thu 8am-8pm, Fri 8am-4pm',url:'https://www.sexualviolencecenter.org/',langs:['English','Spanish'],urg:true,d:['mpls_north','mpls_ne','mpls_phillips','mpls_cedar','mpls_south','mpls_any']}
};
